...
export default function SpeakerLink({ id, name, imageUrl, imagePosition, isMatch }: Props) {
  ...
  const img = imageUrl
    ? <img src={imageUrl} alt={name ?? ''} style={{ width: '2.5rem', height: '2.5rem', objectFit: 'cover', objectPosition: imagePosition ?? 'center center', borderRadius: '50%', border: '2px solid #1a1a1a', flexShrink: 0, display: 'block' }} />
